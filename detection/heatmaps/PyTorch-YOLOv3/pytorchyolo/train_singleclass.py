...
def run(args):
    ...
    log_file = open("YOLOv3_channels3_singleclass.txt", "w")
    sys.stdout = log_file
    ...
    os.makedirs("checkpoints_YOLOv3_channels3_singleclass", exist_ok=True)
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if epoch % args.checkpoint_interval == 0:
            checkpoint_path = f"checkpoints_YOLOv3_channels3_singleclass/yolov3_ckpt_{epoch}.pth"
