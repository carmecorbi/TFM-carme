...
for seq_name in os.listdir(base_path):
    ...
    # Crear les carpetes corresponents
    ...
    with open(det_file_path, 'w') as det_file:
        for annotation in data.get("annotations", []):
            ...
            frame_id = int(image_id[-3:])  # Agafar els últims 3 dígits

            category_id = annotation["category_id"]
            if category_id not in [1, 2, 3, 4]:
                continue  # Ignorar altres categories
            ...
            # Escriure la detecció en format MOT
