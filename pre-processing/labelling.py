...
DST_ROOT = "/data-fast/data-server/ccorbi/dataset_tracking/full/labels/test"
IMAGE_WIDTH = 1920
IMAGE_HEIGHT = 1080
MAX_FRAME_ID = 750

# Iterate through each subfolder of the sequence
for sequence in os.listdir(SRC_ROOT):
    ...
    config.optionxform = str  # Preserve uppercase letters in keys
    ...
    with open(gt_path, "r") as f:
        for line in f:
            ...
            # Calculate normalized coordinates in YOLO format
            x_center = (x + w / 2) / IMAGE_WIDTH
            y_center = (y + h / 2) / IMAGE_HEIGHT
            w_norm = w / IMAGE_WIDTH
            h_norm = h / IMAGE_HEIGHT

            class_id = 1 if tracklet_id in ball_ids else 0
